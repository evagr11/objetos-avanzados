...
console.log("hola".lastIndexOf('o')) //1

console.log("hola".includes('h')) //true
console.log("hola".includes('ho')) //true
console.log("hola".includes('hol')) //true
console.log("hola".includes('hola')) //true
console.log("hola".includes('holi')) //false

console.log("hola".startsWith('h')) //true
console.log("hola".endsWith('a')) //true

console.log("hola".slice(1, 3)) //ol  corta justo delante del número que le pasemos
